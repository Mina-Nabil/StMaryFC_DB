                    ...
                    <div class="card-body">
                        ...
                        <div class=row>
                            <div class="col-12 b-r">
                                ...
                                <p class="text-muted">{{$user->USER_LTST_RMDR ? $user->USER_LTST_RMDR : 'N/A'}}</p>
                            </div>
                            <br>
                            <div class="col-12 b-r">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <select name=catg class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                            <option value="" disabled selected>Pick From Payment Categories</option>
                                            @foreach($categories as $catg)
                                            <option value="{{ $catg->id }}" @if(isset($catg) && $catg->id == $user->players_category_id)
                                                selected
